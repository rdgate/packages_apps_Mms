...
package com.android.mms2.dom.smil.parser;
...
public class SmilXmlParser {
    ...
    private void validateDocument(SMILDocument doc) {
         ...
         * @see com.android.mms2.dom.smil.SmilDocumentImpl#getBody()
         */
        doc.getBody();

        /*
         * Calling getLayout() will create "layout" element if it is not present.
         * @see com.android.mms2.dom.smil.SmilDocumentImpl#getLayout()
         */
        doc.getLayout();
    }
}
