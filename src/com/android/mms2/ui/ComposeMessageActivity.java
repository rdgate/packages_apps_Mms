...
import static com.android.mms2.transaction.ProgressCallbackEntity.PROGRESS_ABORT;
import static com.android.mms2.transaction.ProgressCallbackEntity.PROGRESS_COMPLETE;
import static com.android.mms2.transaction.ProgressCallbackEntity.PROGRESS_START;
import static com.android.mms2.transaction.ProgressCallbackEntity.PROGRESS_STATUS_ACTION;
import static com.android.mms2.ui.MessageListAdapter.COLUMN_ID;
import static com.android.mms2.ui.MessageListAdapter.COLUMN_MSG_TYPE;
import static com.android.mms2.ui.MessageListAdapter.PROJECTION;
...
import com.android.mms2.LogTag;
import com.android.mms2.MmsApp;
import com.android.mms2.MmsConfig;
import com.android.mms2.R;
import com.android.mms2.TempFileProvider;
import com.android.mms2.data.Contact;
import com.android.mms2.data.ContactList;
import com.android.mms2.data.Conversation;
import com.android.mms2.data.Conversation.ConversationQueryHandler;
import com.android.mms2.data.WorkingMessage;
import com.android.mms2.data.WorkingMessage.MessageStatusListener;
import com.android.mms2.drm.DrmUtils;
import com.android.mms2.model.SlideModel;
import com.android.mms2.model.SlideshowModel;
import com.android.mms2.templates.TemplateGesturesLibrary;
import com.android.mms2.templates.TemplatesProvider.Template;
import com.android.mms2.transaction.MessagingNotification;
import com.android.mms2.transaction.SmsReceiverService;
import com.android.mms2.ui.MessageListView.OnSizeChangedListener;
import com.android.mms2.ui.MessageUtils.ResizeImageResultCallback;
import com.android.mms2.ui.RecipientsEditor.RecipientContextMenuInfo;
import com.android.mms2.util.DateUtils;
import com.android.mms2.util.DraftCache;
import com.android.mms2.util.EmojiParser;
import com.android.mms2.util.PhoneNumberFormatter;
import com.android.mms2.util.SendingProgressTokenManager;
import com.android.mms2.util.SmileyParser;
import com.android.mms2.util.UnicodeFilter;
import com.android.mms2.widget.MmsWidgetProvider;
        ...
        getAsyncDialog().runAsync(new Runnable() {
            ...
            public void run() {
                ...
                intent.setClassName(ComposeMessageActivity.this,
                        "com.android.mms2.ui.ForwardMessageActivity");
                startActivity(intent);
            }
        }, R.string.building_slideshow_title);
    }
        ...
        try {
            ...
            if (input instanceof FileInputStream) {
                ...
                if (location == null) {
                    ...
                    //      /mnt/sdcard/Android/data/com.android.mms2/cache/.temp1.3gp
